...
export default function BookSearch({onSearch, booksList}) {
    let [searchbookterm, setSearchBookTerm] = useState(null);


    function handleSubmit(e) {
        e.preventDefault();
        onSearch(searchbookterm, booksList);
    }
    return (
        <>
                ...
                <div className="flex">
                    ...
                    >
                        <input
                            ...
                            onKeyUp={(e) => setSearchBookTerm(e.target.value)}
                            required
                        />
